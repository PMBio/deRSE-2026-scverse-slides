...
<p style="margin-bottom: 0.2em; font-size: 1.6em;"><strong>Software from the community</strong></p>
...
<div style="flex: 1.2;">
<img src="images/slide1_conference.png" style="width: 100%; border-radius: 8px;" />
</div>

<div style="flex: 0.8; text-align: center;">

<div style="margin-bottom: 1.2em;">
<div style="font-size: 2.2em; font-weight: bold; line-height: 1.1; color: #3A3A3A;">1,230</div>
<div>Zulip members<br/>(discussion<br/>platform)</div>
</div>

<div style="margin-bottom: 1.2em;">
<div style="font-size: 2.2em; font-weight: bold; line-height: 1.1; color: #3A3A3A;">1,708</div>
<div>Pull requests<br/>(last 365 days)</div>
</div>

<div>
<div style="font-size: 2.2em; font-weight: bold; line-height: 1.1; color: #3A3A3A;">72,569</div>
<div>Daily downloads</div>
</div>
