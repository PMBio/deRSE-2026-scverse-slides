...
:::: {.columns style="font-size: 1.4em;"}
::: {.column width="76%"}
**How can your project benefit from networking with other projects?**

- [AI is shifting paradigms and workflows]{.underline} (e.g. tools for AI agents, LLM-ready documentation)
- Need for a hardened core: share and learn from each other: what works, what doesn't

**How can your project contribute to a national integrated structure for research software?**

- Reuse and contribute to modular, reusable components to support and advance each other's efforts

**What should a national integrated structure for research software achieve?**

- Work together to enable end-to-end open, free scientific workflows
:::
::: {.column width="24%"}
